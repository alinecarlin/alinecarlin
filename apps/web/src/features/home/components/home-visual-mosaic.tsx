    ...
    <section className="container-page py-16 lg:py-24">
      <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        <Reveal variants={motionPresets.blurReveal} className="lg:sticky lg:top-28">
          <p className="eyebrow">Presença em movimento</p>
          <h2 className="mt-4 text-4xl leading-tight sm:text-5xl lg:text-6xl">
            Uma imagem que comunica antes mesmo da primeira frase.
          </h2>
          <p className="text-muted-foreground mt-6 max-w-xl text-base leading-8">
            A narrativa visual combina câmera, bastidor, marca e estratégia. A estética é importante, mas sempre a
            serviço de clareza comercial.
          </p>
        </Reveal>
        ...
        <StaggerReveal className="grid gap-4 sm:grid-cols-2">
          {callouts.map((callout, index) => (
            ...
            >
              <div className="group bg-foreground relative min-h-86 overflow-hidden rounded-3xl border border-white/70 shadow-[0_28px_92px_-64px_hsl(var(--foreground)/0.64)]">
                <Image
                  ...
                  className="size-full min-h-86 object-cover object-center transition duration-700 group-hover:scale-[1.035]"
                />
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-6">
                  <h3 className="font-serif text-3xl leading-tight">{callout.title}</h3>
